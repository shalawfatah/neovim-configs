...
key("n", "<leader>rn", buf .. "rename()<CR>", opts) -- RENAME THE CODE
...
key({ "n", "v" }, "<leader>gl", [[:<C-u>lua require("git-log").check_log()<CR>]], opts) -- SHOW GIT LOG
-- UTILITY KEYS
...
key({ "n", "v" }, "<leader>tr", [[:Trim<CR>]], opts) -- TRIM TRAILING SPACE & LINES
